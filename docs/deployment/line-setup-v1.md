...
1. 打开后台 `/admin/line`
2. 选中该 LINE 用户
3. 点击“发送套餐预约链接 / メニュー予約リンク送信”
4. 顾客应收到一条包含首页专属入口的 LINE 消息
5. 点击后应进入 menu 页面，并可直接选择套餐提交预约

### 8.5 验证定额款式预约

1. 从欢迎消息或后台补发的套餐预约链接进入 menu 页面
2. 点击定额款式中的某个款式
3. 进入预约页
4. 选择时间并提交预约
