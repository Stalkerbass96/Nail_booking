...
const TEXT = {
  zh: {
    ...
    line_msg_gallery_1: "定额套餐链接前文字",
    line_msg_gallery_2: "定额套餐链接后文字",
    line_msg_pending: "预约待确认消息",
    line_msg_confirmed: "预约已确认消息",
    line_msg_rescheduled: "预约改期消息",
    lineHint_welcome: "第 2 行后面自动追加定额套餐链接",
    ...
    // danger zone
    dangerTitle: "测试清库",
    dangerDesc: "清空客户、预约、LINE 会话、定额套餐、分类、套餐和加项等业务数据，并恢复示例目录。管理员账号、系统设置和营业时间会保留。",
  ...
  ja: {
    ...
    line_msg_gallery_1: "定額メニューリンク前メッセージ",
    line_msg_gallery_2: "定額メニューリンク後メッセージ",
    line_msg_pending: "予約受付メッセージ",
    line_msg_confirmed: "予約確認メッセージ",
    line_msg_rescheduled: "予約変更メッセージ",
    lineHint_welcome: "2行目の後に定額メニューリンクが自動付与されます",
    ...
    dangerDesc: "顧客、予約、LINE 会話、定額メニュー、カテゴリ、メニュー、追加オプションなどの業務データを削除し、サンプルカタログを復元します。管理者アカウント、システム設定、営業時間は保持されます。",
