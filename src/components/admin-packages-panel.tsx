...
const TEXT = {
  zh: {
    ...
    updateFailed: "更新失败",
    deleteFailed: "删除套餐失败",
    deleteConfirm: "确定要删除这个套餐吗？如果已经被定额款式或预约引用，系统会拒绝删除。",
    deleteBlocked: "这个套餐已被定额款式或预约引用，不能删除。",
    empty: "暂无套餐",
    moveUp: "上移",
    moveDown: "下移",
  ...
  ja: {
    ...
    deleteConfirm: "このメニューを削除しますか？定額デザインや予約で使われている場合は削除できません。",
    deleteBlocked: "このメニューは定額デザインまたは予約で使われているため削除できません。",
    empty: "メニューはありません",
    moveUp: "上へ",
    moveDown: "下へ",
