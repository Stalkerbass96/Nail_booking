...
const TEXT = {
  zh: {
    ...
    reorderFailed: "排序失败",
    deleteFailed: "删除分类失败",
    deleteConfirm: "确定要删除这个分类吗？如果已经被套餐或定额款式使用，系统会拒绝删除。",
    deleteBlocked: "这个分类已被套餐或定额款式使用，不能删除。",
    empty: "暂无分类"
  },
  ja: {
    title: "カテゴリ管理",
    ...
    deleteConfirm: "このカテゴリを削除しますか？メニューや定額デザインで使われている場合は削除できません。",
    deleteBlocked: "このカテゴリはメニューまたは定額デザインで使われているため削除できません。",
    empty: "カテゴリはありません"
  }
} as const;
