...
const TEXT = {
  zh: {
    ...
    saveSuccess: "定额套餐项已保存",
    reorderSuccess: "定额套餐排序已更新",
    empty: "暂无定额套餐项",
    ...
    status: "状态",
    keyword: "关键词",
    keywordPlaceholder: "搜索定额套餐标题、分类或套餐",
    allCategories: "全部分类",
    allStatuses: "全部状态",
    sortHint: "优先用上移 / 下移调整首页定额套餐顺序。",
    remove: "删除",
    deleteFailed: "删除定额套餐失败",
    deleteSuccess: "定额套餐项已删除",
    deleteConfirm: "确定要删除这个定额套餐项吗？如果已经产生预约，系统会拒绝删除。",
    deleteBlocked: "这个定额套餐项已有预约历史，不能删除。",
    addonsTitle: "固定加项组合",
    ...
    customPriceJpy: "定额套餐专属价（留空则显示原价）",
    customDurationMin: "定额套餐专属时长 min（留空则沿用套餐时长）"
  },
  ja: {
    title: "定額メニュー管理",
    refresh: "更新",
    ...
    unpublished: "非公開",
    appointments: "予約流入",
    loadFailed: "定額メニューの読み込みに失敗しました",
    createFailed: "作成に失敗しました",
    updateFailed: "更新に失敗しました",
    reorderFailed: "並び替えに失敗しました",
    saveSuccess: "定額メニュー項目を保存しました",
    reorderSuccess: "定額メニューの並び順を更新しました",
    empty: "定額メニュー項目はありません",
    ...
    allStatuses: "すべての状態",
    sortHint: "ホーム定額メニューの順番は上へ / 下へで簡単に調整できます。",
    remove: "削除",
    deleteFailed: "定額メニュー項目の削除に失敗しました",
    deleteSuccess: "定額メニュー項目を削除しました",
    deleteConfirm: "この定額メニュー項目を削除しますか？予約履歴がある場合は削除できません。",
    deleteBlocked: "この定額メニュー項目には予約履歴があるため削除できません。",
    ...
    customPriceJpy: "定額メニュー専用価格（空白で通常価格表示）",
    customDurationMin: "定額メニュー専用時間 min（空白でメニュー時間を適用）"
  }
} as const;
