...
const TEXT = {
  zh: {
    title: "LINE 会话管理",
    desc: "集中查看 LINE 用户、1 对 1 会话、绑定状态和图墙预约链接发送情况，方便店长快速跟进预约与沟通。",
    configOn: "LINE 已配置",
    configOff: "LINE 未配置",
    ...
    linkedAt: "绑定时间",
    lastGalleryLinkSentAt: "最近一次发送图墙链接",
    linkHelp: "绑定链接适合已存在客户档案，但还没有和当前 LINE 用户正式关联的场景。",
    galleryHelp: "图墙预约链接适合老好友补发入口，客户点开后会回到门店图墙并继续预约。",
    unread: "未读",
    unreadMessages: "未读消息",
    inboxSummary: "收件箱概览",
    unreadTotal: "未读总数",
  ...
  ja: {
    title: "LINE 会話管理",
    desc: "LINE ユーザー、1 対 1 会話、連携状態、ギャラリー予約リンク送信状況をまとめて確認し、予約対応と個別連絡を進めやすくします。",
    configOn: "LINE 設定済み",
    configOff: "LINE 未設定",
    ...
    linkedAt: "連携日時",
    lastGalleryLinkSentAt: "直近のギャラリーリンク送信",
    linkHelp: "連携リンクは、顧客プロフィールは存在するが現在の LINE ユーザーと未連携な場合に使います。",
    galleryHelp: "ギャラリー予約リンクは、既存の友だちに作品予約入口を再案内したい時に使います。",
    unread: "未読",
