...
const TEXT = {
  zh: {
    title: "LINE 会话管理",
    desc: "集中查看 LINE 用户、1 对 1 会话、绑定状态和套餐预约链接发送情况，方便店长快速跟进预约与沟通。",
    configOn: "LINE 已配置",
    configOff: "LINE 未配置",
    ...
    sendFailed: "发送消息失败",
    linkFailed: "发送绑定链接失败",
    galleryLinkFailed: "发送套餐预约链接失败",
    bind: "绑定客户",
    sendLink: "发送绑定链接",
    sendGalleryLink: "发送套餐预约链接",
    unbind: "解除绑定",
  ...
  ja: {
    title: "LINE 会話管理",
    desc: "LINE ユーザー、1 対 1 会話、連携状態、メニュー予約リンク送信状況をまとめて確認し、予約対応と個別連絡を進めやすくします。",
    configOn: "LINE 設定済み",
    configOff: "LINE 未設定",
    ...
    galleryLinkFailed: "メニュー予約リンクの送信に失敗しました",
    bind: "顧客を連携",
    sendLink: "連携リンクを送る",
    sendGalleryLink: "メニュー予約リンクを送る",
    unbind: "連携解除",
    ...
    galleryLinkSent: "メニュー予約リンクを送信しました",
    galleryLinkReady: "予約リンクを生成しました。コピーできます。",
    copyGalleryLink: "予約リンクをコピー",
    galleryLinkCopied: "メニュー予約リンクをコピーしました",
    webhookHint: "Webhook パス: /api/line/webhook",
    linkedAt: "連携日時",
    lastGalleryLinkSentAt: "直近のメニューリンク送信",
    linkHelp: "連携リンクは、顧客プロフィールは存在するが現在の LINE ユーザーと未連携な場合に使います。",
    galleryHelp: "メニュー予約リンクは、既存の友だちに予約入口を再案内したい時に使います。リンクを開くとメニューページへ移動します。",
    unread: "未読",
