...
const TEXT = {
  zh: {
    title: "LINE 会话管理",
    desc: "查看 LINE 用户、收发消息、绑定顾客档案，并向指定用户发送自助绑定链接。",
    configOn: "LINE 已配置",
    configOff: "LINE 未配置",
    ...
    conversation: "会话记录",
    noMessages: "当前没有消息记录。",
    customerSearch: "搜索顾客姓名或邮箱",
    sendMessage: "发送消息",
    sendPlaceholder: "输入要发送给该 LINE 用户的内容",
    send: "发送",
    searchingCustomers: "搜索中...",
    noCustomers: "没有找到顾客",
    selectUserHint: "先从左侧选择一个 LINE 用户，再查看会话和绑定操作。",
    lastSeen: "最后活跃",
    lastMessage: "最后一条消息",
    following: "已关注",
    notFollowing: "未关注/已取消",
    incoming: "收到",
    outgoing: "发送",
    system: "系统",
    customerBound: "顾客绑定成功",
    ...
    filterLinked: "仅已绑定",
    filterLabel: "筛选",
    conversationRead: "打开会话后会自动将当前收件消息标记为已读。",
    customerActions: "顾客绑定操作",
  ...
  ja: {
    title: "LINE 会話管理",
    desc: "LINE ユーザー一覧、メッセージ送受信、顧客連携、セルフ連携リンク送信をここで管理します。",
    configOn: "LINE 設定済み",
    configOff: "LINE 未設定",
    appBaseOk: "APP_BASE_URL 設定済み",
    appBaseMissing: "APP_BASE_URL 未設定",
    searchPlaceholder: "LINE 名、LINE ID、連携済み顧客で検索",
    search: "検索",
    loadFailed: "LINE ユーザーの取得に失敗しました",
    loadMessagesFailed: "メッセージの取得に失敗しました",
    ...
    noUsers: "条件に一致する LINE ユーザーはいません。",
    conversation: "会話履歴",
    noMessages: "メッセージ履歴はありません。",
    customerSearch: "顧客名またはメールで検索",
    sendMessage: "メッセージ送信",
    sendPlaceholder: "この LINE ユーザーに送る内容を入力",
    send: "送信",
    searchingCustomers: "検索中...",
    noCustomers: "顧客が見つかりません",
    selectUserHint: "左側から LINE ユーザーを選択すると、会話と連携操作を表示します。",
    lastSeen: "最終アクティブ",
    lastMessage: "最新メッセージ",
    following: "友だち追加済み",
    notFollowing: "未追加/ブロック",
    incoming: "受信",
    outgoing: "送信",
    system: "システム",
    customerBound: "顧客連携が完了しました",
    ...
    filterLinked: "連携済みのみ",
    filterLabel: "フィルター",
    conversationRead: "会話を開くと、その時点の受信メッセージを既読にします。",
