...
const TEXT = {
  zh: {
    title: "LINE 会话管理",
    desc: "集中查看 LINE 用户、1 对 1 会话、绑定状态和定额套餐预约链接发送情况，方便店长快速跟进预约与沟通。",
    configOn: "LINE 已配置",
    configOff: "LINE 未配置",
    appBaseOk: "APP_BASE_URL 已配置",
    appBaseMissing: "APP_BASE_URL 未配置",
    searchPlaceholder: "搜索 LINE 昵称、LINE ID 或已绑定客户",
    search: "搜索",
    ...
    sendFailed: "发送消息失败",
    linkFailed: "发送绑定链接失败",
    galleryLinkFailed: "发送定额套餐预约链接失败",
    bind: "绑定客户",
    sendLink: "发送绑定链接",
    sendGalleryLink: "发送定额套餐预约链接",
    unbind: "解除绑定",
    linkedCustomer: "已绑定客户",
    unlinked: "未绑定客户",
    lineUserId: "LINE ID",
    recentUsers: "最近 LINE 用户",
    noUsers: "当前没有符合条件的 LINE 用户。",
    conversation: "会话记录",
    noMessages: "当前还没有消息记录。",
    customerSearch: "搜索要绑定的客户姓名或邮箱",
    sendMessage: "发送消息",
    sendPlaceholder: "输入要发送给客户的 LINE 文本消息",
    send: "发送",
    searchingCustomers: "搜索中...",
    noCustomers: "没有找到匹配客户",
    selectUserHint: "先从左侧选择一个 LINE 用户，再查看会话、发送预约链接或绑定客户。",
    lastSeen: "最后互动",
    lastMessage: "最后一条消息",
    following: "仍在关注",
    notFollowing: "已取消关注 / 已停用",
    incoming: "客户发来",
    outgoing: "店长发送",
    system: "系统事件",
    customerBound: "客户绑定已更新",
    customerUnbound: "已解除客户绑定",
    sent: "消息已发送",
    linkSent: "绑定链接已发送",
    galleryLinkSent: "定额套餐预约链接已发送",
    galleryLinkReady: "预约链接已生成，可直接复制",
    copyGalleryLink: "复制预约链接",
    galleryLinkCopied: "定额套餐预约链接已复制",
    webhookHint: "Webhook 路径: /api/line/webhook",
    linkedAt: "绑定时间",
    lastGalleryLinkSentAt: "最近一次发送定额套餐链接",
    linkHelp: "绑定链接适合已存在客户档案，但还没有和当前 LINE 用户正式关联的场景。",
    galleryHelp: "定额套餐预约链接适合老好友补发入口，客户点开后会回到门店定额套餐并继续预约。",
    unread: "未读",
    unreadMessages: "未读消息",
    inboxSummary: "收件箱概览",
    unreadTotal: "未读总数",
    ...
    filterLinked: "仅已绑定",
    filterLabel: "筛选",
    conversationRead: "打开会话后，该会话中的新进线消息会被标记为已读。",
    customerActions: "客户绑定",
    onlyUnreadEmpty: "当前没有未读会话。",
    onlyLinkedEmpty: "当前没有已绑定客户的 LINE 用户。",
    resultsLabel: "结果数"
  },
  ja: {
    title: "LINE 会話管理",
    desc: "LINE ユーザー、1 対 1 会話、連携状態、定額メニュー予約リンク送信状況をまとめて確認し、予約対応と個別連絡を進めやすくします。",
    configOn: "LINE 設定済み",
    configOff: "LINE 未設定",
    appBaseOk: "APP_BASE_URL 設定済み",
    appBaseMissing: "APP_BASE_URL 未設定",
    searchPlaceholder: "LINE 表示名、LINE ID、連携済み顧客で検索",
    search: "検索",
    loadFailed: "LINE ユーザーの読み込みに失敗しました",
    loadMessagesFailed: "会話メッセージの読み込みに失敗しました",
    bindFailed: "顧客連携に失敗しました",
    sendFailed: "メッセージ送信に失敗しました",
    linkFailed: "連携リンクの送信に失敗しました",
    galleryLinkFailed: "定額メニュー予約リンクの送信に失敗しました",
    bind: "顧客を連携",
    sendLink: "連携リンクを送る",
    sendGalleryLink: "定額メニュー予約リンクを送る",
    unbind: "連携解除",
    linkedCustomer: "連携済み顧客",
    unlinked: "未連携",
    lineUserId: "LINE ID",
    recentUsers: "最近の LINE ユーザー",
    noUsers: "条件に合う LINE ユーザーはいません。",
    conversation: "会話履歴",
    noMessages: "まだメッセージ履歴はありません。",
    customerSearch: "連携する顧客名またはメールで検索",
    sendMessage: "メッセージ送信",
    sendPlaceholder: "このユーザーへ送る LINE テキストメッセージを入力",
    send: "送信",
    searchingCustomers: "検索中...",
    noCustomers: "一致する顧客が見つかりません",
    selectUserHint: "先に左側で LINE ユーザーを選ぶと、会話確認、予約リンク送信、顧客連携が行えます。",
    lastSeen: "最終アクティブ",
    lastMessage: "最新メッセージ",
    following: "友だち追加中",
    notFollowing: "友だち解除 / 無効",
    incoming: "受信",
    outgoing: "送信",
    system: "システム",
    ...
    galleryLinkSent: "定額メニュー予約リンクを送信しました",
    galleryLinkReady: "予約リンクを生成しました。コピーできます。",
    copyGalleryLink: "予約リンクをコピー",
    galleryLinkCopied: "定額メニュー予約リンクをコピーしました",
    webhookHint: "Webhook パス: /api/line/webhook",
    linkedAt: "連携日時",
    lastGalleryLinkSentAt: "直近の定額メニューリンク送信",
    linkHelp: "連携リンクは、顧客プロフィールは存在するが現在の LINE ユーザーと未連携な場合に使います。",
    galleryHelp: "定額メニュー予約リンクは、既存の友だちに作品予約入口を再案内したい時に使います。",
    unread: "未読",
    ...
    filterLinked: "連携済みのみ",
    filterLabel: "フィルター",
    conversationRead: "会話を開くと、その会話内の新着受信メッセージは既読扱いになります。",
    customerActions: "顧客連携",
    onlyUnreadEmpty: "未読会話はありません。",
    onlyLinkedEmpty: "連携済み顧客を持つ LINE ユーザーはいません。",
    resultsLabel: "件数"
  }
} as const;
